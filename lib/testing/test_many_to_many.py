...
def setup_contracts():
    """Reset Contract.all_contracts before each test."""
    Contract.all_contracts = []  # Reset the class variable to ensure clean state
...
def test_contract_contracts_by_date():
    """Test Contract class has method contracts_by_date() that returns contracts filtered by date"""
